...
В репозитории не найден файл лицензии. Если проект предназначен для внешнего использования, стоит добавить `LICENSE`; до этого права по умолчанию сохраняются за автором.
